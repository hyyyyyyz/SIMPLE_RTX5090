...
_PLACE_HEIGHT = 0.45
_LOWER_HEIGHT = 0.05
@TaskRegistry.register("g1_wholebody_bend_pick_and_place_teleop")
class G1WholebodyBendPickAndPlaceTeleop(Task):
    uid:str = "g1_wholebody_bend_pick_and_place_teleop"
    label: str = "G1 Wholebody Bend Pick and Place Teleop"
    description: str = "A task where the G1 Wholebody robot must bend and pick up an object and place it on the container."
